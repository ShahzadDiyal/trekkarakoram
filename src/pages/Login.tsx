...
import { Mail, Lock, LogIn, Github, Chrome, AlertCircle, Loader2 } from 'lucide-react';
      ...
      <Container className="relative z-20 flex justify-center">
        ...
        >
          <div className="text-center mb-10">
            ...
            <p className="text-white/50 font-light">Continue your journey with us</p>
          </div>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-4">
                ...
                <Link to="#" className="text-[10px] uppercase tracking-widest font-bold text-mountain-accent hover:underline">Forgot?</Link>
              </div>
              <div className="relative group">
                <div className="absolute inset-y-0 left-6 flex items-center pointer-events-none text-white/20 group-focus-within:text-mountain-accent transition-colors">
                  <Lock size={18} />
            ...
            >
              <span className="relative z-10 flex items-center justify-center">
                {loading ? <Loader2 size={20} className="animate-spin mr-2" /> : 'Log In'}
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-[10px] uppercase tracking-widest font-bold">
              <span className="px-4 bg-transparent text-white/20">Or continue with</span>
            </div>
          </div>
          ...
          <p className="mt-8 text-center text-sm text-white/40">
            ...
            <Link to="/signup" className="text-mountain-accent font-bold hover:underline">Sign up now</Link>
          </p>
        </motion.div>
      </Container>
    </div>
